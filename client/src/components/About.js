  ...
  return (
    <div className="about container">
      ...
      <p>
        ...
        140 characters. But as days went by, several new features ( or <em>distractions</em> ) were
        added to Twitter. With the increasing number of distractions such as Images, Links,
